...
import net.draimcido.draimfarming.api.event.*;
...
import net.draimcido.draimfarming.managers.listener.InteractListener;
...
import net.draimcido.draimfarming.utils.HologramUtil;
...
public abstract class HandlerP extends Function {
    ...
    public void load() {
        super.load();
        Bukkit.getPluginManager().registerEvents(interactListener, Main.plugin);
    }
