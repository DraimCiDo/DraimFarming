...
import net.draimcido.draimfarming.integrations.skill.*;
...
import net.draimcido.draimfarming.requirements.Biome;
import net.draimcido.draimfarming.requirements.Permission;
import net.draimcido.draimfarming.requirements.Requirement;
import net.draimcido.draimfarming.requirements.YPos;
        ...
        keys.forEach(key -> {
            ...
            if (config.contains("crops." + key + ".requirements")){
                ...
                config.getConfigurationSection("crops." + key + ".requirements").getValues(false).forEach((requirement, value) -> {
                    switch (requirement){
                        case "world" -> requirements.add(new net.draimcido.draimfarming.requirements.World((List<String>) value));
